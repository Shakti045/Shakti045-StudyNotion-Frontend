...
// }
  return (
    <div className=" relative w-full h-full">
       {
        videourl?<ReactPlayer  onStart={starthandler}  ref={reference} onEnded={endhandler}  width={"100%"} height={"100%"} controls  url={videourl}/>:<p className=" text-3xl font-bold text-center relative lg:top-[40vh] top-[10vh]">No Video Uploaded By Instructor</p>
       }
